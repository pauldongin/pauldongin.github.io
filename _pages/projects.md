...
## ChangeMakers Camp EMA — ProudMe app-to-Qualtrics workflow
...
([App Store](https://apps.apple.com/us/app/proudme-healthy-habits/id6772700786)) for notification
delivery, and an institutionally licensed Qualtrics survey for data capture.
...
**Deployment.** 34 children ages 10–11 across two cohorts; 30 scheduled prompts per child over
...
reconciliation. Delivery, by contrast, depended on three per-child preconditions — app build
version, iOS notification permission, and dashboard enrollment — that were never recorded for every
child. That contrast is the central lesson carried into the formative feasibility write-up.

[**Download the implementation summary (PDF)**]({{ base_path }}/files/ChangeMakers-Camp-EMA-Summary.pdf) &nbsp;·&nbsp;
[EMA questionnaire (.qsf)]({{ base_path }}/files/Ecological-Momentary-Assessment-Questionnaire.qsf)
